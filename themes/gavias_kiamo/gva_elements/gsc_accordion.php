      ...
      public static function sc_accordion( $attr, $content = null ){
         ...
         <div class="gsc-accordion">
            <div class="margin-top-10 margin-bottom-10">
               <a href="#" class="btn btn-default openall"><?php print t('Open All') ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="#" class="btn btn-default closeall"><?php print t('Close All') ?></a>
            </div>   
                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading" role="tab">
                        <h4 class="panel-title">
                          <a role="button" data-toggle="collapse" class="collapsed" data-parent="#<?php print $_id; ?>" href="#<?php print ($_id . '-' . $i) ?>" aria-expanded="true" aria-controls="collapseOne">
                            <?php print $tab['title'] ?>
                          </a>
                        </h4>
                     </div>
                     <div id="<?php print ($_id . '-' . $i) ?>" class="panel-collapse collapse" role="tabpanel">
